...
const Waveform = (allProps) => {
    const propsWithDefauls = mergeProps({ logScale: false, mode: "peak", lineWidth: 1 }, allProps);
    ...
    createEffect(() => {
        ...
        if (!Number.isFinite(samplesPerPx) || samplesPerPx <= 0)
            return;
    ...
    createEffect(() => {
        ...
        const { width } = canvasDimensions();
        if (!scrollbarDivRef?.parentElement)
            return;
    ...
    return (<div class="Waveform" {...divProps} style={{
      ...
      <Show when={!(progress() === 0 || progress() === 1)}>
        <div class="Waveform-Spinner" style={{
            display: "flex",
            position: "absolute",
            left: 0,
            top: 0,
      ...
      <div class="Waveform-Scroller" style={{
            position: "absolute",
            left: 0,
            bottom: 0,
            width: "100%",
        ...
        <div class="Waveform-ScrollbarDiv" ref={scrollbarDivRef} style={{ height: "100%", position: "relative" }}/>
      </div>

      <div class="Waveform-ContentContainer" style={{
            position: "absolute",
            left: 0,
            bottom: 0,
            width: "100%",

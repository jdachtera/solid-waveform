export function drawSampleDots(ctx, peaks, radius) {
...
export function drawPeaks(ctx, peaks) {
    ctx.beginPath();
...
export function drawWaveform(ctx, peaks) {
    ctx.beginPath();
...
export const drawWaveformWithPeaks = async ({ peaks, waveformStyle, peaksStyle, sampleDotsStyle, width, height, context, scale = 1, logScale = false, }) => {

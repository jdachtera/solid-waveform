...
const Regions = (props) => {
    ...
    return (<div class="Waveform-Regions" style={{ position: "absolute", left: 0, top: 0, width: "100%", height: "100%" }} onMouseDown={handleMouseDown}>
      <Index each={props.regions}>
        {(region) => (<Region region={region()} duration={context.duration} onUpdateRegion={props.onUpdateRegion} onClickRegion={props.onClickRegion} onDblClickRegion={props.onDblClickRegion}/>)}
      </Index>
    </div>);
};
